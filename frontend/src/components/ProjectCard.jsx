...
const ProjectCard = ({ project, index }) => {
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -8 }}
    >
      <Tilt options={defaultOptions} className="w-full group relative h-full glass-interactive rounded-2xl overflow-hidden transform-3d border border-white/5 shadow-[0_8px_32px_0_rgba(0,0,0,0.36)] hover:shadow-purple-500/20">
